...
namespace linmath {
    ...
    class Mat3 {
       ...
       Mat3<T> operator%(const T t) {
        ...
        static Mat3<T> zero();
        static Mat3<T> onei(int ind);
        static Mat3<T> oner(int row);
        static Mat3<T> onec(int col);
    ...
    template <typename T>
    Mat3<T> Mat3<T>::onei(int ind) {
        Mat3<T> mat(.0);
        mat[ind] = 1;
        return mat;
    }
    template <typename T>
    Mat3<T> Mat3<T>::oner(int row) {
        Mat3<T> mat(.0);
